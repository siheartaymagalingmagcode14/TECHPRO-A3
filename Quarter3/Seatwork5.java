...
public class Seatwork5 {
    public static void main(String[] args) {
        BankAccount mySavings = new SavingsAccount("DIH-6767", 1000.00);
        ...
        System.out.println("New Savings: $" + mySavings.getBalance());
        System.out.println("——————————————");

        myChecking.displayAccountInfo();
        myChecking.calculateInterest();

        System.out.println(BankAccount.BOLD + "Transaction finished." + BankAccount.RESET);
    }
}