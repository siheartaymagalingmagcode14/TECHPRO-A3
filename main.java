...
protected void deposit(double amount) {
    ...
    class SavingsAccount extends BankAccount {
        ...
        public SavingsAccount(String accountNumber, doubleBalance) {
    ...
    public class Main {
        public static void main (String[] args) {
            BankAccount mySavings = new SavingsAccount("SAV-9910", 1000);
            BankAccount myChecking = new CheckingAccount("CHK-4452", 500);

            System.out.println("\n" + BankAccount.
            BOLD + "~~~ BANKING SYSTEM DASHBOARD ~~~ "  + BankAccount.RESET);

            mySavings.displayAccountInfo();
            mySavings.calculateInterest();
            System.out.println("Update Savings: $" + mySavings.getBalance());
